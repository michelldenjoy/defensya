...
function Corners({ size = 16, onDark = false }: { size?: number; onDark?: boolean }) {
...
function SectionHeader({
  eyebrow, title, accent, onDark = false,
}: {
  eyebrow: string; title: string; accent?: string; onDark?: boolean;
}) {
  return (
    <div className="mb-14">
      <div className="flex items-center gap-3 mb-5">
        <span className="w-2 h-2 rounded-full bg-defensya-blue animate-[blink_1.4s_step-end_infinite]" />
  ...
  return (
    ...
    >
      ...
      {/* ══════════════════════════════════════════════════════════
          §1 HERO — LIGHT bg-white / dark:bg-defensya-navy
      ══════════════════════════════════════════════════════════ */}
      <section className="relative px-6 lg:px-16 pt-32 pb-28 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid lg:grid-cols-[1fr_40%] gap-12 lg:gap-20 items-end">
            <h1
            ...
            <div className="flex flex-col gap-8">
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed
                ...
                En Defensya, la innovación es el motor que impulsa nuestro compromiso en la
                industria aeroespacial. Desarrollamos soluciones avanzadas que transforman
                la defensa y la seguridad, desde sistemas de reabastecimiento en vuelo hasta
            ...
            {[
              ...
              <div key={label} className="flex items-center gap-6">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="font-mono text-[9px] tracking-[0.3em] text-gray-400 uppercase">{label}</span>
      ...
      <section className="relative px-6 lg:px-16 py-28 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          <SectionHeader eyebrow="Contexto" title="El reto y" accent="nuestra visión" />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              {/* Ghost num */}
              <span className="pointer-events-none absolute top-2 right-4 font-mono font-black
                              select-none text-black/[0.04] dark:text-white/[0.04]
                              group-hover:text-defensya-blue/[0.07] transition-colors duration-500"
                style={{ fontSize: "5rem", lineHeight: 1 }}>01</span>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                Tradicionalmente, el reabastecimiento aire-aire ha sido una operación manual
                que requiere una elevada precisión por parte del operador. Aunque esta
                capacidad actúa como un importante multiplicador de fuerza en las operaciones
                aéreas, su rendimiento sigue condicionado por los límites del factor humano.
              </p>
            </div>
            ...
            >
              ...
              <span className="pointer-events-none absolute top-2 right-4 font-mono font-black
                              select-none text-black/[0.04] dark:text-white/[0.04]
                              group-hover:text-defensya-blue/[0.07] transition-colors duration-500"
                style={{ fontSize: "5rem", lineHeight: 1 }}>02</span>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                Defensya impulsa la evolución hacia sistemas de reabastecimiento automatizados
                capaces de mejorar la precisión, reducir riesgos operativos y mantener el
      ...
      <section className="relative px-6 lg:px-16 py-28 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          <SectionHeader eyebrow="Automatización" title="Niveles de" accent="automatización" onDark />

          {/* Table header */}
          <div className="hidden sm:grid sm:grid-cols-[180px_220px_1fr] gap-6 lg:gap-8
          ...
          {[
            ...
            <div key={item.name}
              ...
              <span className="hidden sm:block font-mono text-[10px] tracking-[0.2em]
      ...
      <section className="relative px-6 lg:px-16 py-28 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          <SectionHeader eyebrow="Beneficios" title="Ventajas" accent="operativas" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                {/* Ghost number */}
                <span className="pointer-events-none absolute top-1 right-3 font-mono font-black
                                select-none text-black/[0.04] dark:text-white/[0.04]
      ...
      <section className="relative px-6 lg:px-16 py-28 overflow-hidden bg-defensya-navy">
        ...
        <div className="max-w-7xl mx-auto relative">
          <SectionHeader eyebrow="Tecnologías" title="Tecnologías" accent="clave" onDark />

          {/* ── Boomerang — text row ── */}
          <div className="group relative flex flex-col sm:grid sm:grid-cols-[200px_220px_1fr]
                          gap-3 sm:gap-6 lg:gap-8 items-start
            ...
            <p className="text-sm text-gray-400 leading-relaxed
                         group-hover:text-gray-300 transition-colors duration-300">
              Tecnología diseñada para mejorar la precisión en la localización del receptáculo
              de repostaje. Reduce significativamente las latencias del sistema aire-aire,
              permitiendo operaciones estables incluso en condiciones de fuerte turbulencia.
            </p>
          </div>
          ...
          >
            ...
            {/* Gradient overlays */}
            <div className="absolute inset-0"
              style={{ background: "linear-gradient(to right, rgba(6,13,24,0.97) 0%, rgba(6,13,24,0.82) 50%, rgba(6,13,24,0.35) 100%)" }} />
            <div className="absolute inset-0"
            ...
            {/* Ghost text */}
            <span className="pointer-events-none absolute bottom-4 right-8 font-mono font-black
                            select-none text-white/[0.04] group-hover:text-defensya-blue/[0.06]
                            transition-colors duration-500"
              style={{ fontSize: "9rem", lineHeight: 1 }}>HX</span>
              ...
              <div className="flex-1 max-w-xl">
                ...
                <div className="flex items-center gap-3 mb-6">
                  <span className="inline-flex items-center gap-2 font-mono text-[10px] tracking-[0.25em]
                                  text-defensya-blue border border-defensya-blue/40 px-3 py-1.5 uppercase">
                    <span className="w-1.5 h-1.5 rounded-full bg-defensya-blue"
                      style={{ animation: "blink 1.4s step-end infinite" }} />
                    Haptic Boom Control · Producto Estrella
                  </span>
                </div>
                ...
                <p className="text-sm text-gray-300 leading-relaxed max-w-md mb-8">
                  Dispositivo de control manual con retroalimentación háptica que permite controlar
                  el botalón de forma natural e intuitiva. Una sola mano, precisión total.
                  Facilita la transición desde operaciones manuales hacia entornos A3R®.
                </p>
