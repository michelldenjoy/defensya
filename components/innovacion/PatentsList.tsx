      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <p className="text-slate-400 text-lg leading-relaxed max-w-4xl">
            ...
            A lo largo de más de veinticinco años de actividad hemos registrado <span className='text-white'>más de veinte patentes</span>, 
            algunas de las cuales ya han sido cedidas a clientes como <span className='text-white'>EADS (Airbus)</span>.
          </p>
        </div>
