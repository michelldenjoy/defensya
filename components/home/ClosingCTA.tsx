...
/* HUD-style seam divider — sits between ClosingCTA and Footer */
function SectionDivider() {
  return (
    <div className="relative bg-[#060d18] py-7 md:py-9 overflow-hidden">
      {/* faint grid continuation, matches CTA background texture */}
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 flex items-center justify-center gap-4">
        <div className="hidden sm:block flex-1 h-px bg-gradient-to-r from-transparent via-defensya-blue/25 to-defensya-blue/40" />

        <div className="relative flex items-center gap-3 px-5 py-2">
          <HUDBracket corner="tl" className="-top-1.5 -left-2.5" />
          <HUDBracket corner="br" className="-bottom-1.5 -right-2.5" />
          <span className="w-1 h-1 rounded-full bg-defensya-blue" />
          <span
            className="text-[9px] md:text-[10px] tracking-[0.35em] uppercase text-slate-500 whitespace-nowrap"
            style={{ fontFamily: "'Share Tech Mono', monospace" }}
          >
            DFS · Ingeniería Verificada
          </span>
          <span className="w-1 h-1 rounded-full bg-defensya-blue" />
        </div>

        <div className="hidden sm:block flex-1 h-px bg-gradient-to-l from-transparent via-defensya-blue/25 to-defensya-blue/40" />
      </div>
    </div>
  );
}
