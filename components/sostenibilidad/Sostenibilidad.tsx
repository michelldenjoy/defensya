        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_38%] gap-12 lg:gap-20 items-center">
            ...
            <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed lg:pb-2">
              Defensya Ingeniería Internacional establece, implanta y mejora un Sistema
              de Gestión de la Calidad y Medio Ambiente, asegurando, controlando y
              optimizando la calidad de sus servicios con el objetivo de satisfacer
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-[1fr_56%] items-center gap-12 lg:gap-20">
            ...
            <p className="text-md text-gray-500 dark:text-gray-400 leading-relaxed">
              Defensya Ingeniería Internacional, a través del presente compromiso,
              suscrito por todos los trabajadores, establece que todas nuestras
              actividades, productos y servicios se desarrollan desde la perspectiva
              de la satisfacción, la protección y conservación del medio ambiente como
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-14">
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-display, 'Barlow Condensed', sans-serif)" }}
            >
              Compromisos<br />Medioambientales
            </h2>
          </div>
      ...
      <section className="px-6 lg:px-16 py-24
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4
            ...
            {[
              { num: "01", label: "Gestión de residuos",    desc: "Reducción y tratamiento controlado de residuos industriales en todos los procesos de fabricación." },
              { num: "02", label: "Eficiencia energética",  desc: "Optimización del consumo energético en instalaciones y equipos de producción." },
              { num: "03", label: "Cadena de suministro",   desc: "Selección y colaboración con proveedores que cumplan los requisitos ambientales establecidos." },
              { num: "04", label: "Formación ambiental",    desc: "Capacitación continua del equipo en buenas prácticas medioambientales y normativa vigente." },
            ].map(({ num, label, desc }) => (
              <div
                key={num}
      ...
      <section className="px-6 lg:px-16 py-24
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[auto_1fr] gap-6 items-start
            ...
            <div>
              <p className="text-[12px] font-mono tracking-[0.3em] text-defensya-blue
                            uppercase mb-4">
                Declaración final
              </p>
