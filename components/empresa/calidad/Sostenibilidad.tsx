...
function SectionTag({ children }: { children: React.ReactNode }) {
    return (
      <p className="text-[12px] font-mono tracking-[0.3em] text-slate-400 uppercase mb-3">
        {children}
      </p>
    );
  }
export default function Sostenibilidad() {
  ...
  return (
    <main >
      <section className="px-6 lg:px-16 py-15 bg-gradient-to-r from-slate-900 to-black/95">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[1fr_auto] gap-8 lg:gap-20 items-center">
            <div>
              <SectionTag>Mejora continua</SectionTag>
              <h2
                className="text-3xl lg:text-5xl font-bold uppercase leading-tight text-slate-300"

              >
                Sostenibilidad
              </h2>
              <p className="text-sm text-slate-400 leading-relaxed mt-3 max-w-md">
