...
const MODOS: Modo[] = [
  ...
  },
  {
    ...
    descripcion:
      "Crea paredes virtuales de software para evitar impactos con el cockpit, fuselaje o alas del receptor. Mantiene el equipo dentro del margen de seguridad.",
  },
  {
...
export default function HaptixPage() {
  ...
  return (
    ...
    >
      ...
      ══════════════════════════════════════════════════════════════ */}
      <section
        className="relative min-h-screen grid lg:grid-cols-[1fr_48%] overflow-hidden
      ...
      >
          ...
          >
            ...
            >
              {[
                ...
                >
                  <p
                    className="font-bold text-3xl text-white leading-none mb-2"
                    style={{
                      fontFamily:
                        "var(--font-display, 'Barlow Condensed', sans-serif)",
                    }}
                  ...
                  <span
                    className="absolute bottom-0 left-0 right-0 h-[1px] bg-defensya-blue
        ...
        >
          ...
          <div className="absolute bottom-0 inset-x-0 z-20 px-8 py-6 flex items-end justify-between">
            ...
            <span
              className="font-mono font-black text-white/[0.05] select-none"
      ...
      ══════════════════════════════════════════════════════════════ */}
      <section
        className="relative px-6 lg:px-16 py-18 overflow-hidden
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 mb-16 items-end">
            ...
            >
              ...
              manos del operador. Haptix® redefine esta interacción con un único
              dispositivo de control háptico.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  <span
                    className="w-1 h-1 rounded-full bg-defensya-blue"
                    style={{ animation: "step-end infinite" }}
                  />
                  Haptix® Device
                </span>
              </div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                ...
                para controlar el boom. Ofrece maniobrabilidad superior, siendo
                extremadamente intuitivo. Reduce los recursos necesarios y
                permite alcanzar nivel de experto en una fracción del tiempo
                habitual.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
            ...
            <div className="relative group">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(14,165,233,0.2) 0%, transparent 60%)",
                  clipPath:
              ...
              >
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        background:
                          "linear-gradient(to top, rgba(6,13,24,0.9) 0%, transparent 50%)",
                      }}
                    />
                  </motion.div>
                </AnimatePresence>
                ...
                <div className="absolute top-5 left-5 z-20">
                  <span
                    className="inline-flex items-center gap-2 font-mono text-[10px] tracking-[0.25em]
                                  text-white border border-defensya-blue/40 bg-black/90 px-3 py-1.5 uppercase"
                  >
                ...
                {/* Ghost number */}
                <span
                  className="pointer-events-none absolute bottom-4 right-5 font-mono font-black
                                select-none text-white/[0.04]"
                ...
                <div className="absolute bottom-0 inset-x-0 h-0.5 bg-white/5 z-20">
                  <motion.div
                    ...
                    initial={false}
                    animate={{
                      width: `${((current + 1) / HAPTIX_IMAGES.length) * 100}%`,
                    }}
                ...
                <div
                  className="absolute inset-x-5 top-1/2 -translate-y-1/2 flex justify-between z-30
            ...
            <div className="flex flex-col gap-4">
              {[
                ...
                >
                  {/* left accent bar */}
                  <span
                    className="absolute left-0 top-0 bottom-0 w-[2px] bg-defensya-blue
                                  scale-y-0 group-hover:scale-y-100 transition-transform duration-300 origin-top"
                  />

                  <div className="flex items-center gap-4 mb-3">
                    <span className="font-mono text-[10px] tracking-[0.3em] text-defensya-blue">
                      {f.num}
                    </span>
                    <div className="h-px w-5 bg-defensya-blue" />
                    <h4
                      className="text-lg font-bold uppercase leading-none text-white
                                  group-hover:text-defensya-blue transition-colors duration-300"
                      style={{
                        fontFamily:
                          "var(--font-display, 'Barlow Condensed', sans-serif) font-md",
                      }}
                    >
                      {f.titulo}
                    </h4>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center mb-16">
            ...
            <p
              className="text-md text-gray-500 dark:text-gray-400 leading-relaxed
                         border-l-2 border-defensya-blue/30 pl-5 mb-14"
            >
              Hardware rugerizado y certificado para entornos de misión crítica,
              con cumplimiento de los estándares RTCA internacionales.
            </p>
          </div>
                  ...
                  {sec.items.map((item, idx) => (
                    <div
                      ...
                      className="p-4 bg-white dark:bg-black/20
                                   border border-gray-100 dark:border-white/[0.05] transition-colors group"
                    >
          ...
          {/* Bottom doc ref */}
          <div
            className="mt-16 pt-8 border-t border-gray-100 dark:border-white/[0.07]
